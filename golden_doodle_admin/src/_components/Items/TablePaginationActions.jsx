...
const columnData = [
  ...
  { id: 'unity_measure', numeric: false, disablePadding: false, label: 'Un. Medida' },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{n.category && n.category.name}</TableCell>
                      <TableCell>{n.unity_measure && n.unity_measure.name}</TableCell>
                      <TableCell numeric>{n.qtt}</TableCell>
